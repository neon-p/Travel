        ...
        <div class="ml-auto order-0">
          ...
          <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" style="font-weight: 600;" href="logout.php" class="btn btn-outline">Logout</a>
                  </li>
                </ul>
          </div> 
        </div> 
          ...
          <div class="team_item">
            <div class="team_body">
              <div class="section_title_container text-center">
                <a href="admin_add_division_select.php">Add</a>
                <a href="admin_edit_area_select.php">Edit</a>
              </div>
            </div>
          </div>
        </div>
